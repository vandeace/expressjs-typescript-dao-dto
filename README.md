# EXPRESS JS, TYPESCRIPT WITH IMPLEMENTING DAO AND DTO

A project made from this _Building a Node.js/TypeScript REST API_ series at the Toptal Engineering Blog:
